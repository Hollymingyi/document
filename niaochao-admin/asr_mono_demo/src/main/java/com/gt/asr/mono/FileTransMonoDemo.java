 ...
 * 阿里云录音文件识别 — 单声道版 Demo。
 * <p>
 * 与双声道版的区别：不设置 speaker_num 和 supervise_type，适用于单声道录音文件。
 * <p>
 * 环境变量：
 ...
 */
public class FileTransMonoDemo {
    ...
    public static final String KEY_AUDIO_SPLIT = "auto_split";
    ...
    public FileTransMonoDemo(String accessKeyId, String accessKeySecret) {
        // 设置endpoint
        try {
    ...
    public String submitFileTransRequest(String appKey, String fileLink) {
        ...
        taskObject.put(KEY_AUDIO_SPLIT, true);
         taskObject.put("download_method", "curl");
        // 单声道：不设置 speaker_num 和 supervise_type
    ...
    public static void main(String args[]) throws Exception {
        ...
        final String appKey = "nior994SIK7WQlTI";//"W5QoYTsVAPUkp5pa";

        if (args.length == 0) {
            System.err.println("用法: java -jar asr-mono-demo-1.0.0.jar <音频文件URL或本地路径>");
            System.exit(1);
        }
        String fileLink = args[0];

        FileTransMonoDemo demo = new FileTransMonoDemo(accessKeyId, accessKeySecret);
